...
export const SCHOOL_DAY_TEMPLATE: PanelTemplate[] = [
  ...
  { id: "s2", name: "School Mode",   anchor: "middle", timeLabel: "7:20AM–1:30PM" },
  { id: "s3", name: "Midday Reset",  anchor: "middle", timeLabel: "1:30–2:30PM"   },
  { id: "s4", name: "After Hours",   anchor: "middle", timeLabel: "2:30–6:00PM"   },
  { id: "s5", name: "Wind Down",     anchor: "last",   timeLabel: "6:00–9:30PM"   },
]
